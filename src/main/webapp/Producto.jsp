...
<html>
    ...
    <body>
        <h1 style="color:blue;font-size:300%;text-align:center;">PRODUCTOS</h1>
        <div class="d-flex"> 
            <div class="card col-sm-4">
                <div class="card-body" >
                    <form action="Controlador?menu=Producto" method="POST">
                        ...
                        <div class="form-group">
                            <label>Precio</label>
                            <input type="number" min="1" value="${producto.getPrecio()}" name="Precio" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Cantidad</label>
                            <input type="number" min="1" value="${producto.getStock()}" name="Cantidad" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
