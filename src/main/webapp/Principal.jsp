...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-primary">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a style="margin-left: 10px; border:none" class="btn btn-outline-light" href="Controlador?menu=Ordenes&accion=listar" target="myframe">Ordenes</a>
                    </li>
                </ul>
            </div>
            <div class="dropdown">
        ...
        <div class="m-4" style="height: 550px;">
         ...
         <div align="center"><img src="img/logo2.jpg" alt="logo2" style="width:20%"></div>
