...
<html>
    ...
    <body>
        <h1 style="color:blue;font-size:300%;text-align:center;">NUEVA VENTA</h1>
        <div class="d-flex">
                    ...
                    <form action="Controlador?menu=RegistrarVenta" method="post">
                        <div class="card-body"> 
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" min="1" name="cant" value="1" class="form-control" >
                                </div>
                                <div class="col-sm-3">
            ...
            <div class="col-sm-7">
                <div class="card"> 
                    <div class="card-body"> 
                        <img src="img/logo2.jpg" alt="90" width="190"/>
                        <div class="d-flex col-sm-5 ml-auto">
                            <label class ="text-right mt-2 col-sm-6">N°Serie </label>
                    ...
                    <div class="card-footer d-flex">
                        ...
                        <div class="col-sm-3 ml-auto">
                            <input type=" text" name="txtTotal" value="S/. ${total}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
